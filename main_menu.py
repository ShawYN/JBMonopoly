...
upImageFilename1 = 'Resources/graphics/Start_unSelected8040.PNG'
downImageFilename1 = 'Resources/graphics/Start_Selected8040.PNG'
upImageFilename2 = 'Resources/graphics/Setting_unSelected8040.PNG'
downImageFilename2 = 'Resources/graphics/Setting_Selected8040.PNG'
upImageFilename3 = 'Resources/graphics/Exit_unSelected8040.PNG'
downImageFilename3 = 'Resources/graphics/Exit_Selected8040.PNG'
'''
...
class mainMenu(object):
	def __init__(self, allgroup):
		pygame.init()
		pygame.mixer.init()
		self.screen = pygame.display.set_mode((270, 360))
		pygame.display.set_caption("Monopoly!")
	...
	def setup(self,allgroup, backgroundgroup, buttongroup, penguingroup):
		...
		self.downButton1 = downButton(downImageFilename1, pygame.math.Vector2(90, 220), -2, allgroup, buttongroup)
